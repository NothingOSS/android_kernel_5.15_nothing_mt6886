...
static ssize_t fts_game_mode_show(
	struct device *dev, struct device_attribute *attr, char *buf)
{
	int count = 0;
	u8 val = 0;
...
static ssize_t fts_pocket_mode_show(
	struct device *dev, struct device_attribute *attr, char *buf)
{
	int count = 0;
	struct fts_ts_data *ts_data = dev_get_drvdata(dev);
...
static DEVICE_ATTR(fts_game_mode, S_IRUGO | S_IWUSR,
...
static DEVICE_ATTR(fts_pocket_mode, S_IRUGO | S_IWUSR,
		fts_pocket_mode_show, fts_pocket_mode_store);
static struct attribute *fts_touch_mode_attrs[] = {
	&dev_attr_fts_glove_mode.attr,
	&dev_attr_fts_cover_mode.attr,
	&dev_attr_fts_game_mode.attr,
	&dev_attr_fts_edge_mode.attr,
	&dev_attr_fts_pocket_mode.attr,
	NULL,
};
