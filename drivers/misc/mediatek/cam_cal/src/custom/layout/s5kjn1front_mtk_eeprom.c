...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000001, 0x171403, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000001, 0x00002BDD, 0x00000012, do_fuse_id},
	}
};

struct STRUCT_CAM_CAL_CONFIG_STRUCT s5kjn1front_mtk_eeprom = {
	.name = "s5kjn1front_mtk_eeprom",
	.check_layout_function = layout_check,
	.read_function = Common_read_region,
	.layout = &cal_layout_table,
	.sensor_id = S5KJN1FRONT_SENSOR_ID,
	.i2c_write_id = 0xA4,
	.max_size = 0x4000,
	.enable_preload = 1,
	.preload_size = 0x4000,
