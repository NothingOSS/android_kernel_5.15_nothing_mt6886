...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000001, 0x171403, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		{0x00000001, 0x00000000, 0x00000000, do_module_version},
		{0x00000001, 0x00000005, 0x00000002, do_part_number},
		{0x00000001, 0x0000006B, 0x0000074C, do_single_lsc},
		{0x00000001, 0x00000032, 0x0000000E, do_2a_gain},
		...
		{0x00000001, 0x00000007, 0x00000002, do_lens_id},
		{0x00000001, 0x00000ED9, 0x00000015, do_fuse_id},
	}
};

struct STRUCT_CAM_CAL_CONFIG_STRUCT imx615_mtk_eeprom = {
	.name = "imx615_mtk_eeprom",
