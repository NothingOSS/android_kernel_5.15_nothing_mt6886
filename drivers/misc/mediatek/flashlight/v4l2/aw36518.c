 ...
 */
#define AW36518_FLASH_TOUT_MIN 100
#define AW36518_FLASH_TOUT_STEP 50
#define AW36518_FLASH_TOUT_MAX 400
...
struct aw36518_flash {
	...
	unsigned long target_current[AW36518_LED_MAX];
	unsigned long ori_current[AW36518_LED_MAX];
};
...
#define AW36518_PINCTRL_STATE_HWEN_HIGH "hwen-high"
#define AW36518_PINCTRL_STATE_HWEN_LOW  "hwen-low"
/******************************************************************************
				...
				unsigned int tout)
{
	...
	if (tout == 50)
		...
		tout_bits = 0x07 + (tout / AW36518_FLASH_TOUT_STEP);
...
static int aw36518_init(struct aw36518_flash *flash)
{
	...
	aw36518_torch_brt_ctrl(flash, AW36518_LED0,
				flash->ori_current[AW36518_LED0]);
	aw36518_torch_brt_ctrl(flash, AW36518_LED1,
				flash->ori_current[AW36518_LED1]);
	aw36518_flash_brt_ctrl(flash, AW36518_LED0,
				flash->ori_current[AW36518_LED0]);
	aw36518_flash_brt_ctrl(flash, AW36518_LED1,
				flash->ori_current[AW36518_LED1]);
					...
					unsigned long state)
{
	...
	if (flash->target_state == 0) {
		flash->need_cooler = 0;
		flash->target_current[AW36518_LED0] = AW36518_FLASH_BRT_MAX;
		flash->target_current[AW36518_LED1] = AW36518_FLASH_BRT_MAX;
		...
		flash->need_cooler = 1;
		flash->target_current[AW36518_LED0] =
			flash_state_to_current_limit[flash->target_state - 1];
		flash->target_current[AW36518_LED1] =
			flash_state_to_current_limit[flash->target_state - 1];
		ret = aw36518_torch_brt_ctrl(flash, AW36518_LED0,
					flash->target_current[AW36518_LED0]);
		ret = aw36518_torch_brt_ctrl(flash, AW36518_LED1,
			...
			const struct i2c_device_id *devid)
{
	...
	flash->target_current[AW36518_LED0] = AW36518_FLASH_BRT_MAX;
	flash->target_current[AW36518_LED1] = AW36518_FLASH_BRT_MAX;
	flash->ori_current[AW36518_LED0] = AW36518_TORCH_BRT_MIN;
	flash->ori_current[AW36518_LED1] = AW36518_TORCH_BRT_MIN;
