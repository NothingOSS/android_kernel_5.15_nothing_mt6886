...
#define MT6886_VLP_AXI_PROT_EN_ADSP_TOP	(BIT(29) | BIT(30))
#define MT6886_VLP_AXI_PROT_EN_ADSP_TOP_2ND	(BIT(14) | BIT(16) |  \
			BIT(17))
#define MT6886_VLP_AXI_PROT_EN_ADSP_TOP_3RD	(BIT(23) | BIT(24))
...
static const struct scp_domain_data scp_domain_mt6886_spm_data[] = {
	...
	[MT6886_POWER_DOMAIN_ADSP_TOP_DORMANT] = {
		...
		.bp_table = {
			...
			BUS_PROT_IGN(VLP_TYPE, 0x0214, 0x0218, 0x0210, 0x0220,
				MT6886_VLP_AXI_PROT_EN_ADSP_TOP_3RD),
		},
	...
	[MT6886_POWER_DOMAIN_MM_INFRA] = {
		...
		.bp_table = {
			...
			BUS_PROT_IGN(EMI_TYPE, 0x84, 0x88, 0x40, 0x8c,
